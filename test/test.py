...
if __name__ == '__main__':
    ...
    for id, (lr, batch, shuffle, epochs, momentum) in enumerate(product(*param_values)):
        ...
        test_dataloader = DataLoader(test_data, batch_size=batch, shuffle=shuffle)
        ...
        comment = f' epch={epochs} lr={lr} bch={batch} shfl={shuffle}'
        helper = t.TorchHelperClass(model=net, loss_function=criterion, optimizer=optimizer, comment=comment)
